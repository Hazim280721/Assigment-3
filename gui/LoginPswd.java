...
public class LoginPswd extends JFrame {
	...
	public LoginPswd() {
		...
		LoginButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if(UserNameTextField.getText().equals("Azman") && PasswordTextField.getText().equals("aby123")) {
		...
		LoginButton.setBounds(426, 374, 187, 53);
		...
		ImejLabel.setIcon(new ImageIcon("D:\\AZMAN YASIN JUN 2020\\GAMBAR LAMA\\DCIM PHONE 20 Sept 2016\\Facebook\\FB_IMG_1425174241699-1.jpg"));
		ImejLabel.setBounds(689, 158, 214, 269);
		panel.add(ImejLabel);
	}
}
